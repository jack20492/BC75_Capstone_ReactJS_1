    ...
    <>
      <ConfigProvider locale={enEN} button={{ className: "bg-blue-500" }}>
        <ModalForm
          ...
          title="Add film"
          trigger={
            <button className="mb-3 px-6 py-2 bg-blue-700 text-white rounded-lg hover:bg-blue-500 duration-300">
              Add film
            </button>
          }
          form={form}
        ...
        >
          <ProForm.Group>
            ...
            <ProFormText
              ...
              rules={[
                { required: true, message: "Please input film trailer!" },
                {
            ...
            <ProFormText
              ...
              rules={[
                { required: true, message: "Please input film poster!" },
                {
            ...
            <ProFormDatePicker
              ...
              rules={[
                { required: true, message: "Please input started date!" },
              ]}
              onChange={(value) => {
                console.log(value);
              }}
